...
- ```bash 
terraform init
```: This initialises our Terraform backend, as well as our modules, allowing us to actually start working with Terraform. Ensure that you run this command before any of the others
